...
struct IUvrStereoDevice
{
	virtual ~IUvrStereoDevice()
	{ }
	...
	*/
	virtual void SetSwapSyncPolicy(EUvrSwapSyncPolicy policy) = 0;
	...
	*/
	virtual EUvrSwapSyncPolicy GetSwapSyncPolicy() const = 0;
};
