...
class UvrVrpnAnalogInputDataHolder :
	public UvrInputDeviceBase<EUvrInputDevice::VrpnAnalog>
{
public:
	UvrVrpnAnalogInputDataHolder(const SUvrConfigInput& config);
	virtual ~UvrVrpnAnalogInputDataHolder();
